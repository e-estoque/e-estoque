...
/**
 * Relatório de gastos e vendas mensais (últimos 12 meses).
...
public class RelatorioGastosMensais implements Relatorio {
    ...
    public void gerar() {
        ...
        for (Object[] row : gastos) {
            ...
            System.out.printf("  %s/%d  R$ %12,.2f  %12d%n",
                    MESES[mes], ano, total, numCompras);
